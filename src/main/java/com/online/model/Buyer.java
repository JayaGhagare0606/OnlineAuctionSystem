...
public class Buyer {
	...
	public Buyer(int id, String fullname, String email, String mobile, String password, String dob, int age,
	...
	public String toString() {
		return "Buyer [id=" + id + ", fullname=" + fullname + ", email=" + email + ", mobile=" + mobile + ", password="
