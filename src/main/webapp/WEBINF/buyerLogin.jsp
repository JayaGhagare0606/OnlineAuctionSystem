...
<body>
	...
	<div class="container mt-5">
		<div class="card">
			...
			<form:form action="/api/buyer/doBuyerLogin" method="post" modelAttribute="buyer">
				<div class="row mt-5">

					<div class=" col-md-5">
						<div class="card-body">
							<div class="d-flex justify-content-center display-5">BuyerLogin</div>
							...
							<button class="btn btn-primary mt-4" type="submit">Buyer Login</button>
						</div>
					</div>
