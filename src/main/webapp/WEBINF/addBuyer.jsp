			...
			<li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/api/seller/addSeller">Add Seller</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/api/buyer/addBuyer">Add Buyer</a>
				...
				<div class="container-fluid">
					...
					<div class="container d-flex justify-content-center mt-5">
						<div class="card" style="width: 400px;">
							...
							<form:form action="${route}" method="post" modelAttribute="buyer">
								<div class="row mt-4">
									...
									<div class=" col">
										<div class="card-body">
											...
											<div class="form-floating mt-4">
												...
												<form:input path="fullname" type="text" class="form-control" value="${oneBuyer.fullname}"
													id="floatingInput" placeholder="FullName" />
													<label for="floatingInput">FullName</label>
											</div>
											<div class="form-floating mt-4">
												
												<form:input path="email" type="email" class="form-control" value="${oneBuyer.email}"
													id="floatingInput" placeholder="name@example.com" />
													<label for="floatingInput">Email address</label>
											</div>
											<div class="form-floating mt-4">
												
												<form:input path="mobile" type="tel" class="form-control" value="${oneBuyer.mobile}"
											...
											<div class="form-floating mt-4">
												...
												<form:input path="password" type="password"
													class="form-control" value="${oneBuyer.password}" id="floatingPassword"
													placeholder="Password" />
													<label for="floatingPassword">Password</label>
											</div>
											<div class="form-floating mt-4">
												
												<form:input path="dob" type="text" class="form-control" value="${oneBuyer.dob}"
													id="floatingInput" placeholder="Dob" />
													<label for="floatingInput">DOB</label>
											</div>
											<div class="form-floating mt-4">
												
												<form:input path="age" type="text" class="form-control" value="${oneBuyer.age}"
													id="floatingInput" placeholder="Age" />
													<label for="floatingInput">Age</label>
											</div>
											<div class="form-floating mt-4">
												
												<form:input path="gender" type="text" class="form-control" value="${oneBuyer.gender}"
													id="floatingInput" placeholder="Gender" />
													<label for="floatingInput">Gender</label>
											</div>
											<div class="form-floating mt-4">
												
												<form:input path="address" type="text" class="form-control" value="${oneBuyer.address}"
													id="floatingInput" placeholder="Address" />
													<label for="floatingInput">Address</label>
											</div>
											<div class="form-floating mt-4">
												
												<form:input path="pincode" type="text" class="form-control" value="${oneBuyer.pincode}"
													id="floatingInput" placeholder="Pincode" />
													<label for="floatingInput">Pin code</label>
											</div>
											<div class="form-floating mt-4">
												
												<form:input path="city" type="text" class="form-control" value="${oneBuyer.city}"
													id="floatingInput" placeholder="City" />
													<label for="floatingInput">City</label>
											</div>
											<div class="form-floating mt-4">
												
												<form:input path="state" type="text" class="form-control" value="${oneBuyer.state}"
													id="floatingInput" placeholder="State" />
													<label for="floatingInput">State</label>
											</div>
											<div class="form-floating mt-4">
												
												<form:input path="country" type="text" class="form-control" value="${oneBuyer.country}"
											...
											<div class="form-floating mt-4">
												...
												<form:input path="type" type="text" class="form-control" value="${oneBuyer.type}"
