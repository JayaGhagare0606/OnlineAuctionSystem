    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="/api/admin/dashboard">
          ...
          <c:if test="${data.type == 'admin' }">
             ...
             <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/api/admin/addAdmin">Add Admin</a>
                        <a class="collapse-item" href="/api/admin/adminList">Admin List</a>
                    </div>
                </div>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">${data.fullname}</span>
                                <span class="mr-2 d-none d-lg-inline text-gray-900 small">(${data.type})</span>
