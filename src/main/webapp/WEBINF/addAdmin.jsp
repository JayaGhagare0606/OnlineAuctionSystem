	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link"
				href="/api/admin/dashboard"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>Dashboard</span></a>
			</li>
									...
									<div class=" col">
										<div class="card-body">
											...
											<div class="form-floating mt-4">
												...
												<form:input path="fullname" type="text" class="form-control" value="${oneAdmin.fullname}"
													id="floatingInput" placeholder="FullName" />
													<label for="floatingInput">FullName</label>
											</div>
											<div class="form-floating mt-4">
												
												<form:input path="email" type="email" class="form-control" value="${oneAdmin.email}"
											...
											<div class="form-floating mt-4">
												...
												<form:input path="password" type="password"
													class="form-control" value="${oneAdmin.password}" id="floatingPassword"
													placeholder="Password" />
													<label for="floatingPassword">Password</label>
											</div>
											<div class="form-floating mt-4">
												
												<form:input path="mobile" type="tel" class="form-control" value="${oneAdmin.mobile}"
													id="floatingInput" placeholder="Mobile" />
													<label for="floatingInput">Mobile</label>
											</div>
											<div class="form-floating mt-4">
												
												<form:input path="type" type="text" class="form-control" value="${oneAdmin.type}"
													id="floatingInput" placeholder="Type" />
													<label for="floatingInput">Type</label>
											</div>
											<div class="form-floating mt-4">
												
												<form:input path="status" type="text" class="form-control" value="${oneAdmin.status}"
