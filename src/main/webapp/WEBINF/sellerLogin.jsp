...
<body>
	...
	<div class="container mt-5">
		<div class="card">
			...
			<form:form action="/api/seller/doSellerLogin" method="post"
				modelAttribute="seller">
				<div class="row mt-5">

					<div class=" col-md-5">
						<div class="card-body">
							<div class="d-flex justify-content-center display-5">SellerLogin</div>
							...
							<div class="form-floating mb-4">
								<form:input path="email" type="email" class="form-control mt-5"
							...
							<button class="btn btn-primary mt-4" type="submit">Seller
								Login</button>
						</div>
					</div>
